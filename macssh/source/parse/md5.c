...
void EEncode (unsigned char *output, unsigned long *input, unsigned short len);
void EDecode (unsigned long *output, unsigned char *input, unsigned short len);
...
void otpmd5final (unsigned char *digest, struct otpmdx_ctx *context)
{
  ...
  otpmd5update(context, PADDING, padLen);

  /* Append length (before padding) */
  otpmd5update(context, bits, 8);
